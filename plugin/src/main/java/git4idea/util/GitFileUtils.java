...
public class GitFileUtils {
    private static final Logger LOG = LoggerFactory.getLogger(GitFileUtils.class);
    ...
    private static void updateUntrackedFilesHolderOnFileRemove(
        @Nonnull Project project,
        @Nonnull VirtualFile root,
    ...
    private static void addPaths(
        @Nonnull Project project, @Nonnull VirtualFile root,
        @Nonnull List<List<String>> chunkedPaths
    ) throws VcsException {
    ...
    public static boolean shouldIgnoreCaseChange(@Nonnull String onePath, @Nonnull String secondPath) {
        return !Platform.current().fs().isCaseSensitive() && onlyCaseChanged(onePath, secondPath);
    }
